		...
		<div class="bg-gradient-to-br from-blue-50 to-sky-50 border border-blue-100 rounded-xl p-5 mb-6 shadow-xs">
			<div class="max-w-none">
				<p class="text-stone-700">
					I am <strong class="font-semibold text-blue-600">VOCAL</strong>, an expert AI assistant for the
					<strong class="font-semibold text-stone-800">dbGENVOC database</strong>. I specialize in
